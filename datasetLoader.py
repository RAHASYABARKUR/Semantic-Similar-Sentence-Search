...
def get_dataset():
    dataset = fetch_20newsgroups(subset='train', shuffle=True, remove=('headers', 'footers', 'quotes'))
    ...
    dataset_test = fetch_20newsgroups(subset='test', shuffle=True, remove=('headers', 'footers', 'quotes'))
    ...
    print('Train DataFame shape: ' + str(df.shape) + " and Test Dataframe shape " + str(df_test.shape))
